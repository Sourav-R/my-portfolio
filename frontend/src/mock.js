...
export const profileData = {
  ...
  resumeUrl:
    "/Sourav_Ramakrishna_Security-Engineer.pdf",
...
export const allProjects = [
  {
    ...
    problem:
      "A public transport enterprise expanding to 650 employees needed a new high-speed backbone. Existing infrastructure was bottlenecked, risking broadcast storms and severe latency during peak video conferencing and web traffic.",
    stack: [
    ...
    impact:
      "Delivered a highly resilient, enterprise-grade network guaranteeing 20-25 Mbps per wired user. Zero risk of network-wide broadcast failures and future-proofed for over 200 concurrent peak users at 60Mbps each.",
    difficulty: "Expert",
    type: "Enterprise",
  ...
  },
  {
    ...
    problem:
      "Monash University's three distributed campuses suffered from a flat, insecure network architecture, leaving highly sensitive internal systems vulnerable to eavesdropping and lateral movement by external threat actors.",
    stack: [
      "IPSec IKEv2",
      "AES-256-GCM",
      "Mikrotik RouterOS",
    ...
    impact:
      "Deep packet inspection verified 100% of inter-campus traffic was successfully encapsulated and encrypted. Zero-Trust firewall neutralized lateral movement risks while allowing legitimate established connections.",
    difficulty: "Advanced",
    type: "Enterprise",
    thumbnail: "/api/placeholder/600/400",
    demoUrl: "#",
  ...
  },
  {
    ...
    problem:
      "Standard commercial scanners were easily blocked by the network's Snort IDS. The organization needed a bespoke tool to evaluate IDS efficacy against stealthy reconnaissance tactics actively employed by APTs.",
    stack: [
      "Python 3",
      "TCP SYN Scanning",
      "Snort IDS",
    ...
    impact:
      "Successfully enumerated all open TCP and UDP ports without triggering Snort IDS alarms. Proved that rate-based/signature-based IDS configurations are vulnerable to programmatic evasion.",
    difficulty: "Expert",
  ...
  },
  {
    ...
    problem:
      "The organization required a practical demonstration of catastrophic DNS redirection attacks to justify the costly deployment of DNSSEC, as their existing DNS inherently lacked cryptographic authentication.",
    stack: [
      "Python",
      "Scapy",
      "BIND9",
    ...
    impact:
      "Devastatingly effective attacks successfully bypassed standard resolution and poisoned the BIND9 cache, overwriting NS records and hijacking traffic for an entire domain zone. Definitively proved the urgent need for DNSSEC.",
    difficulty: "Expert",
  ...
  },
  {
    ...
    problem:
      "Critical internal web applications and SMTP mail gateways were operating in plaintext or utilizing unverified, self-signed certificates, leaving the enterprise vulnerable to packet sniffing and MITM interception.",
    stack: [
      "OpenSSL",
      "X.509 Certificates",
      "RSA-2048",
    ...
    impact:
      "Seamlessly transitioned the enterprise to a fully encrypted environment, eliminating untrusted certificate warnings. Packet analysis proved all application data payloads were securely encrypted via AES-GCM and authenticated via SHA256.",
    difficulty: "Advanced",
    type: "Enterprise",
    thumbnail: "/api/placeholder/600/400",
    demoUrl: "#",
  ...
  },
  {
    ...
    problem:
      "Deployed a custom T-Pot environment disguised as a banking portal to capture and visualize live credential harvesting attempts.",
  ...
  },
  {
    ...
    problem:
      "Built a scalable configuration management system to automate server hardening based on CIS Benchmarks.",
  ...
  },
  {
    ...
    problem:
      "Architecture of a high-availability virtualization environment for malware analysis and network traffic monitoring.",
  ...
  },
  {
    ...
    problem:
      "Deployed an object detection service processing Base64-encoded images through YOLOv3-tiny and OpenCV on a Kubernetes cluster with 1 controller and 2 worker nodes on Oracle Cloud Infrastructure.",
    stack: [
      "Flask",
      "Kubernetes",
      "Oracle Cloud (OCI)",
  ...
  },
  {
    ...
    problem:
      "Threat modeled a healthcare application connecting IoT wearable devices to a Cloud API, defining trust boundaries and mitigating information disclosure and spoofing threats.",
    stack: [
      "STRIDE Model",
      "Data Flow Diagrams",
      "RBAC",
  ...
  },
  {
    ...
    problem:
      "Architected a secure enterprise network placing WAF in the DMZ, integrating with SSL termination and internal IDS/IPS to protect public-facing infrastructure.",
    stack: [
      "WAF",
      "DMZ Architecture",
      "IDS/IPS",
    ...
    impact:
      "Defense-in-depth enterprise architecture securing public-facing servers",
    difficulty: "Advanced",
    type: "Enterprise",
    thumbnail: "/api/placeholder/600/400",
    demoUrl: "#",
  ...
  },
  {
    ...
    problem:
      "Executed a complete penetration test on a vulnerable VM, escalating from directory enumeration to full SSH root access through a multi-stage attack chain.",
  ...
  },
  {
    ...
    problem:
      "Executed UNION-based SQL injection, Reflected DOM XSS exploiting eval(), and analyzed CSRF mitigation strategies including Anti-CSRF tokens and SameSite cookies.",
    stack: [
      "SQL Injection",
      "XSS (DOM/Reflected)",
      "CSRF",
  ...
  },
  {
    ...
    tab: "Offensive Security",
    subtitle:
      "Buffer overflow and format string exploitation with bypass techniques",
    problem:
      "Exploited buffer overflows against ASLR, StackGuard, and NX protections, and used format string vulnerabilities to overwrite memory values via %x and %n specifiers.",
    stack: [
      "C",
      "GDB",
      "ASLR Bypass",
    ...
    impact:
      "Low-level memory exploitation demonstrating OS countermeasure limitations",
    difficulty: "Expert",
    type: "Security Research",
    thumbnail: "/api/placeholder/600/400",
    demoUrl: "#",
  ...
  },
  {
    ...
    problem:
      "Built a secure file transfer application implementing end-to-end encryption with hash-based integrity verification for communication over untrusted networks.",
    stack: [
      "Python",
      "Cryptography",
      "Socket Programming",
  ...
  },
  {
    ...
    problem:
      "Designed an object-oriented management system with strict data validation using complex regular expressions and structured error handling throughout.",
    stack: [
      "Python",
      "OOP Design Patterns",
      "Regular Expressions",
  ...
  },
  {
    ...
    problem:
      "Built a Flask backend handling multiple concurrent HTTP POST requests with large Base64 images, addressing Python threading bottlenecks and optimizing for throughput.",
    stack: [
      "Flask",
      "Python",
      "REST API",
  ...
  },
  {
    ...
    problem:
      "Designed an enterprise network with forensic readiness at its core, ensuring critical logs are captured and preserved for post-incident analysis using AAA and SIEM integration.",
    stack: [
      "AAA Server",
      "SIEM",
      "Network Forensics",
  ...
  },
  {
    ...
    problem:
      "Analyzed the 2022 Optus and Alibaba data breaches, identifying critical gaps in preventative measures, crisis communications, and root causes including missing MFA and poor patch management.",
    stack: [
      "Breach Analysis",
      "MFA",
      "Patch Management",
  ...
  },
  {
    ...
    problem:
      "Developed comprehensive ethical hacking policies establishing red team boundaries, balancing vulnerability testing with business continuity and data privacy requirements.",
    stack: [
      "Policy Development",
      "Red Team Operations",
      "Compliance",
  ...
  },
  {
    ...
    tab: "Forensics & Compliance",
    subtitle:
      "Iterative vulnerability assessment for AI bird identification platform",
    problem:
      "Conducted iterative security assessments on a Cloudflare/AWS-hosted platform with AI bird identification, discovering CORS misconfigurations, missing security headers, and implementing comprehensive hardening.",
    stack: [
      "Nikto",
      "WhatWeb",
      "CORS",
    ...
    impact:
      "Hardened production platform from permissive CORS to full security header compliance",
    difficulty: "Advanced",
    type: "Applied",
    thumbnail: "/api/placeholder/600/400",
    demoUrl: "#",
  ...
  },
  {
    ...
    problem:
      "Conduct memory dump analysis, network traffic examination, and endpoint detection techniques to identify and neutralize an APT.",
    stack: ["Wireshark", "Volatility", "YARA", "Splunk", "EDR"],
    solution: [
  ...
  },
  {
    ...
    problem:
      "Analyze WannaCry ransomware outbreak, identify infection vectors, and implement containment strategies to prevent propagation.",
    stack: ["Windows Defender ATP", "Wireshark", "Sysinternals", "PowerShell"],
    solution: [
  ...
  },
  {
    ...
    stack: ["Wireshark", "Hping3", "Nmap", "Snort", "iptables"],
    solution: [
