        ...
        {opsSkills[activeTab].map((skill) => {
          ...
          return (
            <div
              ...
              onMouseLeave={() =>
                onHoverSkill("> [SYSTEM] IDLE... WAITING FOR INPUT")
              }
