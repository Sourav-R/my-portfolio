      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="space-y-4 mb-14">
          {workExperience.map((job, index) => (
            <div
              ...
              className={`bg-[#0a0a0a] border rounded-lg p-6 transition-all duration-300 hover:border-gray-600 ${
                job.current ? "border-emerald-500/30" : "border-gray-800"
              }`}
            >
              <div className="flex items-start gap-4 mb-4">
                <div
                  className={`p-2 rounded ${job.current ? "bg-emerald-500/10" : "bg-cyan-500/10"}`}
                >
                  <Building
                    className={`h-5 w-5 ${job.current ? "text-emerald-500" : "text-cyan-500"}`}
                  />
                </div>
        ...
        <div className="mb-6">
          <h3 className="text-lg font-bold font-mono mb-6 flex items-center gap-2">
            ...
            <span className="text-purple-500">Background</span>
          </h3>
          ...
          {education.map((edu) => (
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-base font-bold text-purple-50">
                    {edu.degree}
                  </h3>
              ...
              {edu.highlights.length > 3 && (
                ...
                >
                  ...
                  {expandedEdu === edu.id
                    ? "less"
                    : `+${edu.highlights.length - 3} more areas`}
                </button>
              )}
            </div>
          ))}
