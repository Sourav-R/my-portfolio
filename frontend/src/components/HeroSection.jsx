...
const HeroSection = ({ setMatrixRed }) => {
  ...
  const bootSequence = [
    ...
    {
      text: `  org:      ${profileData.companyFull}`,
      delay: 1000,
      type: "output-cyan",
    },
    {
      text: `  loc:      ${profileData.location}`,
      delay: 1200,
      type: "output",
    },
      ...
      switch (command) {
        case "help":
          response = [
            ...
            {
              text: "  whoami    - Display user identity",
              type: "output-cyan",
              visible: true,
            },
            {
              text: "  matrix    - Toggle visual override",
              type: "output-cyan",
              visible: true,
            },
            {
              text: "  ping      - Check connection",
              type: "output-cyan",
              visible: true,
            },
            {
            ...
            {
              text: "  sudo      - Execute as superuser",
              type: "output-emerald",
              visible: true,
            },
            {
        ...
        case "whoami":
          response = [
            ...
            {
              text: "WARNING: UNAUTHORIZED QUERY DETECTED",
              type: "text-red-500",
              visible: true,
            },
          ];
        ...
        case "sudo su":
          response = [
            ...
            {
              text: "This incident has been reported to the Global Sentinel Network.",
              type: "output-dim",
              visible: true,
            },
          ];
        ...
        case "matrix":
          ...
          response = [
            ...
            {
              text: "MATRIX COLOR SCHEME UPDATED.",
              type: "output-dim",
              visible: true,
            },
          ];
        ...
        case "ping localhost":
          response = [
            ...
            {
              text: "64 bytes from 127.0.0.1: icmp_seq=1 ttl=64 time=0.042 ms",
              type: "output-white",
              visible: true,
            },
            {
              text: "64 bytes from 127.0.0.1: icmp_seq=2 ttl=64 time=0.038 ms",
              type: "output-white",
              visible: true,
            },
            {
              text: "64 bytes from 127.0.0.1: icmp_seq=3 ttl=64 time=0.045 ms",
              type: "output-white",
              visible: true,
            },
            {
        ...
        case "cat shadow":
          response = [
            {
              text: "root:$6$xyz$abc:18823:0:99999:7:::",
              type: "output-dim",
              visible: true,
            },
            {
              text: "daemon:*:18823:0:99999:7:::",
              type: "output-dim",
              visible: true,
            },
            {
              text: "admin:hunter2:18823:0:99999:7:::",
              type: "output-cyan",
              visible: true,
            },
            {
              text: "guest:*:18823:0:99999:7:::",
              type: "output-dim",
              visible: true,
            },
          ];
  ...
  const getLineClass = (type) => {
    switch (type) {
      ...
      case "output-cyan-large":
        return "text-cyan-400 text-sm font-bold";
      case "output":
  ...
  return (
    ...
    >
      {/* Background layers */}
      <div
        className={`absolute inset-0 ${isDefcon1 ? "bg-red-950/20" : "bg-transparent"}`}
      />
      ...
      <div
        ...
        style={{
          ...
          height: "60%",
          background:
            "radial-gradient(ellipse at 30% 50%, rgba(6,182,212,0.05) 0%, transparent 65%)",
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6 py-20 lg:py-0">
        ...
        <div className="flex items-center gap-3 mb-12">
          ...
          >
            <Shield
              className={`h-3 w-3 ${isDefcon1 ? "text-red-500" : "text-emerald-500"}`}
            />
            <span
              className={`text-[10px] font-mono ${isDefcon1 ? "text-red-400 font-bold" : "text-emerald-400"}`}
            >
              THREAT_LEVEL:{" "}
              {isDefcon1 ? "CRITICAL / DEFCON 1" : securityStatus.level}
            </span>
          </div>
          ...
          <span
            className={`text-[10px] font-mono tracking-wider ${isDefcon1 ? "text-red-500" : "text-gray-700"}`}
          >
            {isDefcon1 ? "LOCKDOWN ACTIVE" : "SYS.ONLINE"}
          </span>
          <span
            className={`w-1.5 h-1.5 rounded-full led-blink ${isDefcon1 ? "bg-red-500" : "bg-emerald-500"}`}
          />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to bottom, transparent, rgba(6,182,212,0.3) 20%, rgba(6,182,212,0.15) 60%, transparent)",
                marginLeft: "-24px",
              }}
            />
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right, rgba(6,182,212,0.3), rgba(255,255,255,0.06) 40%, transparent)",
              }}
            />
          ...
          <div className="order-first lg:order-last">
            <TiltCard intensity={8} scale={1.02}>
              <div
                className="bg-[#080808] rounded-xl overflow-hidden"
                style={{
                  border: "1px solid rgba(255,255,255,0.07)",
                  borderTop: "1px solid rgba(16,185,129,0.35)",
                  boxShadow:
                    "0 0 0 1px rgba(255,255,255,0.02), 0 24px 48px rgba(0,0,0,0.5), 0 0 60px rgba(16,185,129,0.04)",
                }}
              >
                {/* Chrome bar */}
        ...
        <div
          ...
          onClick={() =>
            document
              .getElementById("terminal-sandbox")
              ?.scrollIntoView({ behavior: "smooth" })
          }
        >
          <span className="text-xs text-gray-700 font-mono tracking-widest uppercase group-hover:text-gray-500 transition-colors">
            scroll
          </span>
