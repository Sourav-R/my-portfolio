...
const Portfolio = () => {
  ...
  return (
    <TerminalProvider>
      <div
        className={`min-h-screen relative text-gray-200 ${godMode ? "god-mode" : "bg-gradient-to-br from-[#050b14] via-[#030303] to-[#0a0510]"}`}
      >
        ...
        <main
          className={`relative ${matrixRed ? "matrix-red" : ""}`}
          style={{ zIndex: 2, paddingBottom: "32px" }}
        >
