...
const NotFoundPage = () => {
  ...
  const sequence = [
    ...
    { text: '> UNAUTHORIZED ACCESS ATTEMPT LOGGED.', delay: 1200, color: 'text-red-400' },
    { text: '> TRACING SECURE IP ADDRESS...', delay: 2000, color: 'text-yellow-500' },
    { text: '> [|||||     ] 45%', delay: 2800, color: 'text-cyan-400' },
    { text: '> [||||||||| ] 89%', delay: 3200, color: 'text-cyan-400' },
    { text: '> TRACE COMPLETE. ORIGIN IDENTIFIED.', delay: 3800, color: 'text-emerald-500' },
    { text: '> DEPLOYING COUNTERMEASURES...', delay: 4500, color: 'text-red-500' },
    { text: '> REDIRECTING TO SAFE ZONE IN 3 SECONDS.', delay: 5200, color: 'text-gray-400' }
  ];
    ...
    <div className="min-h-screen bg-[#030303] flex items-center justify-center p-4 font-mono">
      <div className="w-full max-w-2xl bg-[#0a0a0a] border border-red-500/30 rounded-lg shadow-[0_0_30px_rgba(239,68,68,0.15)] overflow-hidden relative">
        ...
        <div className="flex items-center gap-2 px-4 py-2 bg-[#111] border-b border-red-500/20">
          ...
          <span className="text-xs text-red-500/80 tracking-widest uppercase">CRITICAL_ALERT_SYS</span>
        </div>

        {/* Console Body */}
        <div className="p-8 h-[400px]">
          <h1 className="text-4xl font-bold text-red-500 mb-8 glitch-text" data-text="ERROR 404">
            ERROR 404
          </h1>
